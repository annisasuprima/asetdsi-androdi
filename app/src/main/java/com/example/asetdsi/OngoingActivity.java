...
public class OngoingActivity extends AppCompatActivity {
    ...
    RecyclerView rvOngoingPeminjaman;
    ActionBar actionBar;
    Toolbar toolbar;
    TabLayout tabLayout;
    ...
    Button buttonhistorypeminjaman;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager = findViewById(R.id.view_pager_ongoing);
        tabLayout = findViewById(R.id.tabs_ongoing);
        getTabs();

        //initialize and assign variable
        BottomNavigationView bottomNavigationView= findViewById(R.id.bottomNavigationOngoing);
    ...
    private void getTabs() {
        ...
        new Handler().post(new Runnable() {
            @Override
            public void run() {
                tabAdapter.addFragment(OngoingPeminjamanFragment.getInstance(),"Peminjaman");
                tabAdapter.addFragment(OngoingPengusulanFragment.getInstance(),"Pengusulan");
