...
public class HistoryPengusulanActivity extends AppCompatActivity {

    RecyclerView rvHistoryPengusulan;
    ActionBar actionBar;
    Toolbar toolbar;
    TabLayout tabLayout;
    ...
    Button buttonongoingpengusulan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_history_pengusulan);

        actionBar = getSupportActionBar();
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setBackgroundDrawable(new ColorDrawable(getResources().getColor(R.color.ijau)));

        viewPager = findViewById(R.id.view_pager_history_pengusulan);
        tabLayout = findViewById(R.id.tabs_history_pengusulan);
        getTabs();

        //BottomBawah

        //initialize and assign variable
        BottomNavigationView bottomNavigationView= findViewById(R.id.bottomNavigationHistoryPengusulan);
    ...
    private void getTabs() {
        ...
        new Handler().post(new Runnable() {
            @Override
            public void run() {
                tabAdapter2.addFragment(HistoryPeminjamanFragment.getInstance(),"Peminjaman");
                tabAdapter2.addFragment(HistoryPengusulanFragment.getInstance(),"Pengusulan");
