...
public class DetailOngoingPengusulan {
        ...
        public String status_detail_opengusulan;
    public String status_detail_opengusulan_fakultas;

    public DetailOngoingPengusulan(String nama_barang_detail_openg, String detail_spesifikasi_detail_openg, int jumlah_barang_detail_openg, int harga_barang_detail_openg, String sumber_toko_openg, String status_detail_opengusulan, String status_detail_opengusulan_fakultas) {
        ...
        this.status_detail_opengusulan = status_detail_opengusulan;
        this.status_detail_opengusulan_fakultas = status_detail_opengusulan_fakultas;
    }
